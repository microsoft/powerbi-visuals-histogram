...
import { TextProperties as UtilsTextProperties } from "powerbi-visuals-utils-formattingutils/lib/src/interfaces";
...
export const TextProperties: UtilsTextProperties = {
